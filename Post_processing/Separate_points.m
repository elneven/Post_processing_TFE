...
Wexp_graph_point1 = [Wexp_point1, Wexp_point4, Wexp_point2, Wexp_point3];
...
Wexp_graph_mean1 = [Wexp_mean_point1, Wexp_mean_point4, Wexp_mean_point2, Wexp_mean_point3];
...
Wexp_graph_point2 = [Wexp_point5, Wexp_point6, Wexp_point7, Wexp_point8];
...
Wexp_graph_mean2 = [Wexp_mean_point5, Wexp_mean_point6, Wexp_mean_point7, Wexp_mean_point8];
...
Wexp_graph_meanadd = [Wexp_mean_point20, Wexp_mean_point21, Wexp_mean_point22, Wexp_mean_point23];
...
% %grid on;
% 
%% Graphic 1 eta_is vs X
figure(1);
plot(X_graph_mean1 , eta_is_graph_mean1, 'b-o', X_graph_mean2 , eta_is_graph_mean2, 'g-o', X_graph_meanadd , eta_is_graph_meanadd, 'ro');
grid on;

%% Graphic 2 eta_v vs X
figure(2);
...
%% Graphic 5
figure(5);
plot(X_graph_mean1 , Wexp_graph_mean1, 'b-o', X_graph_mean2 , Wexp_graph_mean2, 'g-o'); %, X_graph_meanadd , Wexp_graph_meanadd, 'ro');
grid on;
