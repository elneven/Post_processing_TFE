...
for i=1:length(P1_rawdatas)-1
    ...
    if TimeStep_steady_ind(i)==1 && p<N
        p = p+1;
    elseif p==N && abs(P1_rawdatas(i-p+1)-P1_rawdatas(i))<epsilon_P1 && P1_rawdatas(i)>5.6 && P2_rawdatas(i)>1.9 && abs(m_dot_ORC_rawdatas(i-p+1)-m_dot_ORC_rawdatas(i))<epsilon_m_ORC
